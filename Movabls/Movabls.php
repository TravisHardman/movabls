...
if ($media_id=="") $media_id="percentmedia";
...
if ($function_id =="") $function_id ="Get_Media";
...
if ($interface_id =="") $interface_id ="TEST_INT";
...
$query = "
UPDATE `mvs_media` SET content='$content'
WHERE media_GUID='$media_id'";
$result = mysqli_query($link, $query);
...
$query = "
UPDATE `mvs_functions` SET content='$content'
WHERE function_GUID='$function_id'";
$result = mysqli_query($link, $query);
$timestamp=date("H:i:s"); 
...
$query = "
UPDATE `mvs_interfaces` SET content='$content'
WHERE interface_GUID='$interface_id'";
$result = mysqli_query($link, $query);
$timestamp=date("H:i:s"); 
return  "success! $timestamp";
